...
function ShopPopularity () {
    ...
    const rightButtonclick = ():void => {
        ...
        const next = document.querySelector(".shop__popularity__right") as HTMLElement
        const before = document.querySelector(".shop__popularity") as HTMLElement
        const buttonLeft = document.querySelector(".shop__nextButton__leftdot") as HTMLElement
        const buttonRight = document.querySelector(".shop__nextButton__rightdot") as HTMLElement
    ...
    const leftButtonclick = ():void  => {
        const next = document.querySelector(".shop__popularity__right__move") as HTMLElement
        const before = document.querySelector(".shop__popularity__left__move") as HTMLElement
        const buttonLeft = document.querySelector(".shop__nextButton__leftdot") as HTMLElement
        const buttonRight = document.querySelector(".shop__nextButton__rightdot") as HTMLElement
        if (next == null || before == null || buttonLeft == null || buttonRight ==null) {
            return;
    ...
    return (
        <section className="shop">
            <div className="shop__title__wrap">
                ...
                <Link to={`/list/shop`}>
                <div className="shop__title__button">
                    리스트 더보기
                </div>
                </Link>
            </div>
            <div className="shop__popularity">
                    ...
                    <div className="shop__popularity__img">
                    </div>
            ...
            <div className="shop__nextButton__container">
                <button className="shop__nextButton" onClick={leftButtonclick}><KeyboardArrowLeftIcon fontSize="inherit" /></button>
                <button className="shop__nextButton__leftdot" onClick={leftButtonclick}><FiberManualRecordIcon fontSize="inherit" /></button>
                <button className="shop__nextButton__rightdot"  onClick={rightButtonclick}><FiberManualRecordIcon fontSize="inherit" /></button>
                <button className="shop__nextButton" onClick={rightButtonclick}><KeyboardArrowRightIcon fontSize="inherit" /></button>
            </div>
        </section>
    );
}
