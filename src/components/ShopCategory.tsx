...
function ShopCategory({categoryButtonClick }: CategoryButtonClickProps) {
    ...
    return (
            <section className="ShopCategoryList">
                ...
                {!categoryMore ? <button className="ShopCategoryList__more__down">
                    <ArrowDropDownIcon fontSize="inherit" onClick={moreCategoryButtonDown} />
                    </button> : <button className="ShopCategoryList__more__up">
                    ...
                    {!categoryMore ? 
                        CategoryButton.map((CategoryButton) => (
                            <button className="ShopCategoryList__buttonBox__button" key={CategoryButton}
                    ...
                    {!categoryMore ? 
                        CategoryButton.map((CategoryButton) => (
                            <button className="ShopCategoryList__buttonBox__button__modal" key={CategoryButton}
